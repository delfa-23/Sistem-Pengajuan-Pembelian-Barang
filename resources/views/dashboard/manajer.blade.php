...
<body>
    ...
    <div class="container">
        <h2>Selamat Datang, {{ Auth::user()->name }}!</h2>
            <p>Kelola pengajuan barang di bawah ini dengan mudah.</p>
            <a href="{{ route('pengajuan.index') }}" class="btn">Lihat Daftar Pengajuan</a>
            <a href="{{ route('verification.notice') }}" class="btn1">Verifikasi Email</a><br>
        @if (session('message'))
