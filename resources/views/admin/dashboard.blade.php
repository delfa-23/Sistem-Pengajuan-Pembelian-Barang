...
<body>
    ...
    <div class="container">
        ...
        <p>Kelola pengguna dalam sistem ini.</p>

        <a href="{{ route('admin.karyawan.index') }}" class="btn">Lihat Data Karyawan</a>
        <a href="{{ route('admin.manajer.index') }}" class="btn1">Lihat Data Manajer</a>
        <a href="{{ route('admin.pengajuan.index') }}" class="btn2">Lihat Data Pengajuan Barang</a><br>
    ...
    <style>
        ...
        /* Menjaga tulisan judul "Dashboard Manajer" tetap di kiri */
        .navbar h1 {
            margin: 0;
            font-size: 24px;
            flex-grow: 1;
        ...
        /* Style untuk konten utama (tengah) */
        .container {
            max-width: 800px;
            margin: 50px auto;
            background: #fff;
