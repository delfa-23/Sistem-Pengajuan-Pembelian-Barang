...
<div class="container mt-5">
    ...
    <form action="{{ route('manajer.update', $manajer->id) }}" method="POST">
        ...
        <label>Nama</label>
        <input type="text" name="name" value="{{ old('name', $manajer->name) }}" required>

        <label>Email</label>
        <input type="email" name="email" value="{{ old('email', $manajer->email) }}" required>
